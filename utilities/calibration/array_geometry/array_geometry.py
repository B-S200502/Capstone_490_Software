...
# we store center → camera, so negate measured (46.50, 23.42, 5.06).
ARRAY_CENTER_TO_CAMERA_MM = (-46.50, -23.42, -5.06)
ARRAY_CENTER_TO_CAMERA_DIST_MM = 52.31

# Mics: (label, min_dist_mm, x_mm, y_mm, z_mm); x,y,z = from camera to mic (source of truth for measurements)
MICS_RAW = [
    ("U1", 47.34, 44.60, 15.04, 5.07),
    ("U2", 30.12, 22.70, 19.14, 5.07),
    ("U3", 37.35, 33.20, 16.34, 5.07),
    ("U4", 37.57, 36.80, 5.64, 5.07),
    ("U6", 62.31, 58.10, 21.94, 5.07),
    ("U7", 48.96, 48.70, 0.66, 5.07),
    ("U8", 54.30, 53.30, 9.04, 5.07),
    ("U9", 66.27, 64.80, 12.94, 5.07),
    ("U11", 41.73, 28.20, 30.34, 5.07),
    ("U12", 73.98, 59.30, 43.94, 5.07),
    ("U13", 63.49, 49.50, 39.44, 5.07),
    ("U14", 59.42, 39.00, 44.54, 5.07),
    ("U16", 51.06, 38.60, 33.04, 5.07),
    ("U17", 51.67, 45.40, 24.14, 5.07),
    ("U18", 70.90, 63.30, 31.54, 5.07),
    ("U19", 57.97, 50.20, 28.54, 5.07),
]
